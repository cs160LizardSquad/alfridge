...
//////// STEVEN CALL THIS FUNC EVERY TIME YOU RETURN TO THE MAIN GROCERYLISTS CONTAINER (i.e. clicking done on Add List) //////////
updateGroceryLists();
//////// STEVEN CALL THIS FUNC EVERY TIME YOU RETURN TO THE MAIN GROCERYLISTS CONTAINER (i.e. clicking done on Add List)//////////
